...
const CURRICULUM = {
  mathematics: {
    id: "mathematics", name: "Mathematics", icon: "∑", emoji: "📐",
    color: "#2563EB", light: "#EFF6FF", border: "#BFDBFE",
    topics: [
      {
        id: "algebra", title: "Algebra",
        learn: {
          overview: "Algebra is the branch of mathematics dealing with symbols and rules for manipulating those symbols. It forms the backbone of JAMB Mathematics.",
          keyPoints: [
...
function AuthenticatedApp() {
    ...
    setProgress(prev => {
      ...
      return {
        ...
        [selectedSubject]: {
          ...
          [selectedTopic]: { status: passed ? "passed" : "failed", score, attempts }
        }
      };
    });
    if (passed) {
  ...
  }, [selectedSubject, selectedTopic, testAnswers, unlockNextTopic]);
